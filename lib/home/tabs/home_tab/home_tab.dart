...
class _HomeTabState extends State<HomeTab> {
  ...
  Widget build(BuildContext context) {
    ...
    List<String>categoriesList=["All","Sport","Birthday","Meeting","Gaming","Eating","Holiday","Exhibition","Workshop","Book club"];
        ...
        title: Row(
          ...
          children: [
            Column(
              ...
              children: [
                Text("Welcome back",style: AppStyle.regular14baby,),
                Text("Hanaa Hany",style: AppStyle.bold24baby,),
                SizedBox(height: height*.01,),
                Row(
                  children: [
                    Icon(CupertinoIcons.location_solid,color: AppColors.babyBlueColor,),
                    Text("cairo,egypt",style: AppStyle.regular14baby,)
                  ],
                )
            ...
            Row(
              children: [
            Icon(Icons.sunny,color: AppColors.simonColor,),
            Container(
              padding: EdgeInsets.all(width*.015),
                margin: EdgeInsetsDirectional.only(start: width*.015),
    ...
    children: [
      Container(
        ...
        child:
        DefaultTabController(length: categoriesList.length,
            initialIndex: 0,
            ...
            TabBar(
              ...
              tabAlignment:TabAlignment.start ,
               ...
               //so used map to convert list of string items to list of widget
                ...
                return TabWidget(eventName:categoriesName ,isSelected:selectedIndex== categoriesList.indexOf(categoriesName));
                }).toList()
