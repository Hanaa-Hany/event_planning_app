  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Image.asset(AssetsManager.routeImage,fit: BoxFit.fill,),
            Expanded(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text("hanaahany822@gmail.com",style: AppStyle.medium16baby,
          ...
          Padding(
            ...
            child: ElevatedButton.icon(onPressed: (){
              //logout logic
                ...
                label: Text(AppLocalizations.of(context)!.logout,style: AppStyle.medium20white,),
            style: ButtonStyle(
